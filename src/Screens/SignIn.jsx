...
import '../../design/Screens/signIn.scss'

function SignIn({theme}) {

  return (
    <div className="signIn">
        <div className={"signIn__credentials signIn__credentials--" + theme}>
            <div className="signIn__credentials__email">
                <form className={"signIn__credentials__form signIn__credentials__form--" + theme}>
                    <input type="text" className={'signIn__credentials__form__textInput signIn__credentials__form__textInput--' + theme} placeholder='Email'/>
                    <input type="text" className={'signIn__credentials__form__textInput signIn__credentials__form__textInput--' + theme} placeholder='Password'/>
                    <input type="submit" value="Sign In" className={'signIn__credentials__form__submit signIn__credentials__form__submit--' + theme} />
                </form>
            </div>
            <div className="signIn__credentials__apps">
                <div className={'signIn__credentials__apps__title signIn__credentials__apps__title--' + theme}>
                    <p>Or Sign In Using</p>
                </div>
                <div className="signIn__credentials__apps__logos">
                ...
                <div className={'signIn__credentials__forgotPassword signIn__credentials__forgotPassword--' + theme}>
                    <p>Forgot Password?</p>
                </div>
            </div>
        </div>
        <div className={"signIn__title signIn__title--" + theme}>
            <div className="signIn__title__text">
                <p className='signIn__title__label'><span>We want you</span> to </p>
                <p className='signIn__title__mix'>get <span className='signIn__title__hook'>into Flow</span></p> {/* Add a switch of words */}
            </div>
            <div className="signIn__title__exit">
                <p>Dont have an account?</p>
                <button className={'signIn__title__exit__button signIn__title__exit__button--' + theme}>Sign Up</button>
                <button className={'signIn__title__exit__button signIn__title__exit__button--' + theme}>Go Home</button>
            </div>
        </div>
    </div>
  )
